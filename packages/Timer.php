...
/**
 * Timer.class.php
 * @author Andriss Causs @andris
 * @see http://codeaid.net/php/calculate-script-execution-time-%28php-class%29
 * 
 * Thank you very much to Andriss for providing this wonderful profiling script!
 * -Graham
 */
class Timer
{
